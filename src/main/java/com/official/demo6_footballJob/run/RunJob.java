...
public class RunJob {
    ...
    @Bean("footballJob")
    public Job job(
            @Qualifier("playerloadStep") Step playerloadStep
            , @Qualifier("gameLoadStep") Step gameLoadStep
            , @Qualifier("playerSummarizationStep") Step playerSummarizationStep
    ) {
        /*
        ...
        */
        ...
        SimpleJobBuilder simpleJobBuilder = jobBuilder.start(playerloadStep);
        Job job = simpleJobBuilder.build();
        simpleJobBuilder.next(gameLoadStep);
        simpleJobBuilder.next(playerSummarizationStep);
